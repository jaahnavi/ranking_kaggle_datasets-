...
This project helps business analytics students bridge skill gaps efficiently by recommending the most relevant Kaggle datasets based on missing skills identified from job descriptions.Instead of manually searching through hundreds of datasets, this system:
...
Step 2: Train the Model (only if you want to update the model, skip if you want to use already trained model saved in xgb_ranker.json and scaler.pkl)
...
Key Design Decisions
  ...
  Feature Scaling  
    Uses StandardScaler to normalize:   votes, downloads, usability  
    Saved in:  scaler.pkl
  Model Persistence   
    Saved model:  xgb_ranker.json  
